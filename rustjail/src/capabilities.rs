...
lazy_static! {
	pub static ref CAPSMAP: HashMap<String, Capability> = {
		...
		m.insert("CAP_DAC_READ_SEARCH".to_string(), Capability::CAP_DAC_READ_SEARCH);
		...
		m.insert("CAP_LINUX_IMMUTABLE".to_string(), Capability::CAP_LINUX_IMMUTABLE);
		m.insert("CAP_NET_BIND_SERVICE".to_string(), Capability::CAP_NET_BIND_SERVICE);
		m.insert("CAP_NET_BROADCAST".to_string(), Capability::CAP_NET_BROADCAST);
		...
		m.insert("CAP_SYS_TTY_CONFIG".to_string(), Capability::CAP_SYS_TTY_CONFIG);
		...
		m.insert("CAP_BLOCK_SUSPEND".to_string(), Capability::CAP_BLOCK_SUSPEND);
...
pub fn drop_priviledges(caps: &LinuxCapabilities) -> Result<()> {
	...
	caps::set(None, CapSet::Effective, to_capshashset(caps.Effective.as_ref()))?;
